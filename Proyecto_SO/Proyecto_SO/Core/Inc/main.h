...
#define LED_EXT6_Pin GPIO_PIN_12
#define LED_EXT6_GPIO_Port GPIOB
#define LED_EXT5_Pin GPIO_PIN_13
#define LED_EXT5_GPIO_Port GPIOB
#define LED_EXT4_Pin GPIO_PIN_14
#define LED_EXT4_GPIO_Port GPIOB
#define LED_EXT3_Pin GPIO_PIN_15
#define LED_EXT3_GPIO_Port GPIOB
#define LED_EXT2_Pin GPIO_PIN_8
#define LED_EXT2_GPIO_Port GPIOA
